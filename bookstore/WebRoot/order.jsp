		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath }/orderServlet" method="post">
						<table cellspacing="0" class="infocontent">
							...
							<c:forEach var="cart" items="${cart }" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
												...
												<c:set var="sum" value="${sum+cart.key.price*cart.value}"></c:set>
						</c:forEach>
