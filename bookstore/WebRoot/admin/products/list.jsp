...
<script type="text/javascript">
	...
	function deletebook(id){
		...
		if(confirm("确定删除图书")){
			location.href="${pageContext.request.contextPath}/deleteBook?id="+id;
		}
	}
</script>
</HEAD>
							...
							<c:forEach var="c" items="${book }">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/findBookById?id=${c.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="javascript:deletebook('${c.id}')">
											<img
											src="${pageContext.request.contextPath}/admin/images/i_del.gif"
