				...
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath }/finduserinfo?id=${u.id}">用户信息修改</a>
							</td>
						</tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							...
							<c:forEach var="order" items="${order }" varStatus="vs">
									<tr>
										<td class="tableopentd02">${vs.count }</td>

										<td class="tableopentd02">${order.receiverName }</td>
										<td class="tableopentd02">${order.ordertime }</td>
										<td class="tableopentd02"><a href="${pageContext.request.contextPath }/myAccountorderPay?id=${order.id}&money=${order.money}">${order.paystate==0 ? "未支付":"已支付" }</a></td>
										<td class="tableopentd03"><a href="${pageContext.request.contextPath }/orderFindInfo?orderid=${order.id}">查看</a>&nbsp;&nbsp;
											<a href="#">刪除</a>
										</td>
									</tr>
