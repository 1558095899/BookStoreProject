...
<body>
	<form action="${pageContext.request.contextPath }/orderPayOnline" method="post">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${orderid}" readonly="readonly"> 支付金额：<INPUT
			TYPE="text" NAME="money" value="0.01" readonly="readonly">元
		<div class="divBank">
