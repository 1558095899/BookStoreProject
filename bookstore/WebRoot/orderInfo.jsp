								...
								<table width="100%" border="0" cellspacing="0">
									...
									<tr>
										<td>
											...
											<table width="100%" border="0" cellspacing="0">
										<c:forEach var="o" items="${order.orderitem }" varStatus="vs">	
												<tr>
													<td width="10%">${vs.count }</td>
													<td width="40%">${o.book.name }</td>
													<td width="10%">${o.book.price }</td>
													<td width="10%">${o.buynum }</td>
													<td width="10%">${o.book.price*o.buynum }</td>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath }/myAccountorderPay?id=${order.id}&money=${order.money}"><img src="images/gif53_029.gif" width="204"
