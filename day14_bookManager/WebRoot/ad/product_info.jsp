									...
									<tr>
										<td width="30%">
											...
											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath }/addCardServlet?id=${book.id}"> <img src="images/buybutton.gif" border="0" />
												</a>
											</div>
										</td>
										<td style="padding:20px 5px 5px 5px"><img
											...
											<hr />售价：${book.price }<font color="#FF0000">￥:元</font>
											<hr /> 类别：${book.category }
											<hr />
											<p>
												<b>内容简介：${book.description }</b>
											</p></td>
									</tr>
								</table>
							</td>
